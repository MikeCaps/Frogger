...
public class Frog
{
        ...
        {
                if (point.getX() < frogImage.getX()) //move left
                {
                        frogImage.move (-hopDistance, 0);
                }
                else if (point.getX() > frogImage.getX() + frogImage.getWidth()) //move right
                {
                        frogImage.move (hopDistance, 0);
                }
                else if (point.getY() < frogImage.getY()) //move up
                {
                        frogImage.move (0, -hopDistance);
                }
                else if (point.getY() > frogImage.getY() + frogImage.getHeight()) //move down
                 {
                        frogImage.move (0, hopDistance);
                }
